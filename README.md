...
<table>
  <tr>
    <td width="33%" align="center">
      <img src="assets/research-story/01-discover.jpg" alt="Discover a mismatch" width="100%" /><br />
      <sub><strong>01 · Discover / 发现</strong><br />两份图表对不上。</sub>
    </td>
    <td width="33%" align="center">
      <img src="assets/research-story/02-circle.jpg" alt="Circle the mismatch" width="100%" /><br />
      <sub><strong>02 · Trace / 追查</strong><br />先找到错位的位置。</sub>
    </td>
    <td width="33%" align="center">
      <img src="assets/research-story/03-align.jpg" alt="Align timestamps" width="100%" /><br />
      <sub><strong>03 · Align / 对齐</strong><br />把时间和数据重新理顺。</sub>
    </td>
  </tr>
  <tr>
    <td align="center">
      <img src="assets/research-story/04-clean.jpg" alt="Clean the data" width="100%" /><br />
      <sub><strong>04 · Clean / 清理</strong><br />让输入先变得可信。</sub>
    </td>
    <td align="center">
      <img src="assets/research-story/05-suspect.jpg" alt="Question a backtest" width="100%" /><br />
      <sub><strong>05 · Stress-test / 质疑</strong><br />结果太漂亮，反而要小心。</sub>
    </td>
    <td align="center">
      <img src="assets/research-story/06-cost.jpg" alt="Add costs to the experiment" width="100%" /><br />
      <sub><strong>06 · Rebuild / 重做</strong><br />把成本和现实条件放进来。</sub>
    </td>
  </tr>
  <tr>
    <td align="center">
      <img src="assets/research-story/07-compare.jpg" alt="Compare experiments" width="100%" /><br />
      <sub><strong>07 · Compare / 比较</strong><br />看清哪个结果值得继续。</sub>
    </td>
    <td align="center">
      <img src="assets/research-story/08-tool.jpg" alt="Turn research into a tool" width="100%" /><br />
      <sub><strong>08 · Build / 做成工具</strong><br />把研究变成能使用的界面。</sub>
    </td>
    <td align="center">
      <img src="assets/research-story/09-next-question.jpg" alt="Find the next question" width="100%" /><br />
